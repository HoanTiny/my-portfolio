...
export default function Hero() {
  return (
    <div className="bg-white dark:bg-[#0e0e0f] border border-[var(--border)] rounded-lg overflow-hidden relative min-h-[574px] transition-colors duration-300">
      {/* Background Pattern */}
      ...
      <div className="relative max-w-[1314px] mx-auto px-[36px] py-[50px] flex gap-12">
        {/* Left Side - Image */}
        <div className="relative w-[512px] h-[461px] flex-shrink-0">
          <div className="absolute inset-0 bg-gradient-to-br from-purple-300 via-purple-200 to-pink-200 dark:from-purple-900 dark:via-purple-800 dark:to-pink-900 rounded-2xl" />
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[81px] h-[73px]">
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-500 to-green-600 rounded-full opacity-20" />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-[36px] rounded-full bg-gradient-to-br from-emerald-500 to-green-600" />
          </div>
        </div>
        ...
        <div className="flex-1 pt-[44px]">
          ...
          <p className="font-dm-mono text-[16px] mb-2">
            <span className="text-[var(--theme-primary-1)]">&lt;span&gt;</span>
          ...
          <h1 className="font-urbanist font-bold text-[50px] leading-[1.2] mb-6">
            <span className="text-[var(--foreground)]">Senior </span>
          ...
          <p className="font-dm-mono text-[16px] leading-[1.5] text-[var(--neutral-300)] dark:text-[var(--secondary)] mb-8">
            ...
            <span className="text-[var(--theme-primary-1)]">NodeJS</span>,{" "}
            <span className="text-[var(--theme-primary-1)]">React</span>,{" "}
            <span className="text-[var(--theme-primary-1)]">Angular</span>, and{" "}
            <span className="text-[var(--theme-primary-1)]">Laravel</span>
