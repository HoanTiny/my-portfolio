    ...
    <>
      ...
      >
        ...
        <div className="h-full overflow-y-auto p-8 pt-16">
          ...
          <div
            className={`mb-8 xl:hidden transition-all duration-500 ${
              isOpen
                ? 'opacity-100 translate-x-0 delay-200'
                : 'opacity-0 -translate-x-4'
            }`}
          >
            <h3 className="text-white/50 text-xs uppercase mb-3">Menu</h3>
            <div className="grid grid-cols-2 gap-2">
              {navItems.map(item => (
                <button
                  ...
                  className="rounded-xl border border-white/8 bg-white/4 px-3 py-2.5 text-left font-['DM_Mono'] text-[13px] text-white/78 hover:text-white hover:border-[#a8ff53]/30 hover:bg-[#a8ff53]/8 transition-colors"
                >
                  {item.label}
                </button>
              ))}
